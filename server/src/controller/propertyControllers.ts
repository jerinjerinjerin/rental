...
export const getProperties = async (req: express.Request, res: express.Response): Promise<void> => {
  try {
    const {
      favoriteIds,
      priceMin,
    ...
    if (latitude && longitude) {
      ...
      const degree = radiusInKilometers / 111; //convert kilometers to degrees
