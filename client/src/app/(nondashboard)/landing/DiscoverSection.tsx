...
const DiscoverSection: React.FC = () => {
  return (
    ...
    >
      <div className="max-w-4xl xl:max-w-7xl mx-auto px-6 sm:px-12 xl:px-16">
          ...
          {[
            {
              ...
              description:
                "Browse through our extensive colection of rental properties in your desired location.",
            },
            {
              imageSrc: "/landing-icon-calendar.png",
              title: "Book your Rantel",
              description:
                "Once you've find teh perfect rantel property, easily book it online with just a few clicks.",
            },
            {
